...
void Sift(unsigned char* input, int xsize, int ysize, unsigned char* r, unsigned char* g, unsigned char* b)
{
	...
	buildOB(input, octaves_g, NUMBER_OF_OCTAVES, octavesW_g, octavesH_g);

	buildSS(octaves_g, scaleSpace_g, NUMBER_OF_OCTAVES, NUMBER_OF_SCALES, octavesW_g, octavesH_g, sigmas);

	DoG(dog_g, scaleSpace_g, NUMBER_OF_OCTAVES, NUMBER_OF_SCALES, octavesW_g, octavesH_g);

	extreme(&keyPointList_g, dog_g, NUMBER_OF_OCTAVES, NUMBER_OF_SCALES, octavesW_g, octavesH_g);

	orientation(&keyPointList_g, scaleSpace_g, sigmas, octavesW_g);

	render(input, octavesW_g, octavesH_g, &keyPointList_g, sigmas, r, g, b);
