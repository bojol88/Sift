...
/************************************************
 * extreme:
 * Find extreme points, store them in a linked list
 *
 * Parameter
                ...
                for(jj = (int)radius+1; jj < w-(int)radius-1; jj++){
                    ...
                    if(flagExtrema == 1){
                        ...
                        if(flagEdge == 1){
                            ...
                            tmp->ori =
                                0.0f;
                            keyPointList->size = keyPointList->size+1;

                            if(keyPointList->size == MAX_NUMBER_OF_POINTS){
                                // We reached the maximum number of points
                                return;
                            }
                        }
                    }
